...
export default function Item(props) {
  ...
  return (
    <div className='item-wrapper'>
      ...
      <Routes>
        <Route path="shipping" element={<ItemDetails text={item.shipping}></ItemDetails>}></Route>
        <Route path="description" element={<ItemDetails text={item.description}></ItemDetails>}></Route>
      </Routes>
    </div>
  )
}
